...
const ActiveTaxCard = () => {
  return (
    <div className="px-8 py-6 border border-primary-blue-200 rounded-lg flex gap-x-6 justify-between max-w-[800px]">
      <div className="flex flex-col gap-y-4">
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <Typography variant="intro" className="text-primary-dark-400">
            Skattframtalið þitt er í vinnslu. Haltu áfram til að ljúka og senda
            það inn.
          </Typography>
        </div>
        <div className="w-full h-2 rounded-full bg-primary-blue-100 mt-3">
          <div className="h-full bg-primary-blue-400 rounded-full w-[45%]" />
        </div>
        <Typography
          variant="medium"
