...
export type DebtAndExpensesInput = {
  otherDebts: Array<OtherDebtInput>;
  residentialInterestExpenses: Array<ResidentialPropertyInterestExpenseInput>;
};
...
export type ResidentialPropertyInterestExpense = {
  ...
  outstandingDebt: Scalars['Float']['output'];
  totalPaymentsForYear: Scalars['Float']['output'];
  yearOfPurchase: Scalars['Float']['output'];
};
...
export type ResidentialPropertyInterestExpenseInput = {
  ...
  outstandingDebt: Scalars['Float']['input'];
  totalPaymentsForYear: Scalars['Float']['input'];
  yearOfPurchase: Scalars['Float']['input'];
};
...
export type GetTaxReturnQuery = { __typename?: 'Query', getTaxReturn: { __typename?: 'TaxReturn', id: string, year: number, userId: string, revenue: { __typename?: 'Revenue', wageIncomes: Array<{ __typename?: 'WageIncome', id: string, ssn: string, name: string, salaryAmount: number }>, pensionPayments: Array<{ __typename?: 'PensionPayment', id: string, type: string, name: string, amount: number }>, vehicleAllowances: Array<{ __typename?: 'VehicleAllowance', id: string, type: string, name: string, amount: number }> }, assets: { __typename?: 'Assets', domesticRealEstate: Array<{ __typename?: 'DomesticRealEstate', id: string, landlineNumber: string, address: string, realEstateValuation: number }>, automobiles: Array<{ __typename?: 'Automobile', id: string, plateNumber: string, yearOfPurchase: number, purchasePrice: number }> }, debtAndExpenses: { __typename?: 'DebtAndExpenses', residentialInterestExpenses: Array<{ __typename?: 'ResidentialPropertyInterestExpense', id: string, yearOfPurchase: number, location: string, lender: string, lendersIdNumber: string, loanNumber: string, borrowingDate: any, loanTermYears: number, totalPaymentsForYear: number, faceValue: number, interestExpenses: number, outstandingDebt: number }>, otherDebts: Array<{ __typename?: 'OtherDebt', id: string, title: string, interestExpenses: number, outstandingDebt: number }> } } };
